...
- [Installation](#installation)
  - [1. DynamicVerse Environment](#1-dynamicverse-environment)
  - [2. Download Pre-trained Models](#2-download-pre-trained-models)
- [Quick Start](#quick-start)
  - [Run DynamicGen Demo](#run-dynamicgen-demo)
  - [Qwen2.5-VL Configuration](#qwen25-vl-configuration)
    - [Option 1: API Service (Default)](#option-1-api-service-default)
    - [Option 2: Local Deployment](#option-2-local-deployment)
- [Processing Pipeline](#processing-pipeline)
  - [1. Data Preparation](#1-data-preparation)
  - [2. Keyframe Extraction](#2-keyframe-extraction)
  - [3. Multimodal Analysis](#3-multimodal-analysis)
  - [4. 4D Scene Reconstruction (Optional)](#4-4d-scene-reconstruction-optional)
